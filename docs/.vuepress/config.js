module.exports = {
  ...
  head: [
    ...
    ['script', { src: 'https://cdn.jsdelivr.net/npm/codemirror/lib/codemirror.js' }],
    ['script', { src: 'https://cdn.jsdelivr.net/npm/codemirror/mode/javascript/javascript.js' }],
    ['script', { src: 'https://cdn.jsdelivr.net/npm/codemirror/mode/xml/xml.js' }],
    ['link', { href: 'https://cdn.jsdelivr.net/npm/codemirror/lib/codemirror.css', rel: 'stylesheet' }],
    ['link', { href: 'https://cdn.jsdelivr.net/npm/codemirror/theme/material.css', rel: 'stylesheet' }],
    ['script', { src: '/ga.js' }],
    ['script', { src: '/bt.js' }],
  ],
  plugins: [
